...
if (confirm('Почати тестування?')) {
    class auto {
        constructor(defBrand, defSizeTank, defNumberLitersAvailable, defNumberSeats, defNumberPassengers) {
            this.brand = defBrand,
        ...
        refueling(refuelingLiter) {
            if ((this.sizeTank - this.numberLitersAvailable) > refuelingLiter) {
                this.numberLitersAvailable = this.numberLitersAvailable + refuelingLiter;
            }
            else {
